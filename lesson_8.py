...
#             operator = input("+, -, *, /")
#             num2 = int(input("Введите второе цисло: "))
#             if operator == "+":
#                 print(num1 + num2)
#             elif operator == "-":
#                 print(num1 - num2)
...
#     password_file = open('logib_passwords.txt', 'a+')
...
# print(save_login_password('aschat', 'geekcoin'))
...
def main():
    ...
    while True:
        ...
        if random_number == user_input:
            ...
            print("Спасибо ваши данные запмсаны")
        else:
